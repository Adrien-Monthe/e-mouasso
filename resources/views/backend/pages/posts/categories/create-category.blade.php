            ...
            <div class="col-lg-10">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Multi Columns Form -->
                        <form class="row g-3" method="POST" action="{{ route('bcategories.store', app()->getLocale())  }}" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description_fr" class="form-control" id="description_fr" cols="30" rows="3"></textarea>
                            </div>
