...
@section('content')
  ...
  <section class="page-header">
    <div class="page-header__bg" style="background-image: url('/frontend/images/backgrounds/services-1-1.jpg');">
    </div>
    ...
    <div class="container">
        <div class="page-header__inner">
            <h2>@lang('services.legal_and_administrative_support')</h2>
            <div class="thm-breadcrumb__inner">
                <ul class="thm-breadcrumb list-unstyled">
                    ...
                    <li><span>/</span></li>
                    <li>@lang('services.legal_and_administrative_support')</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="services-details__right">
                    <div class="services-details__img">
                        <img src="{{url('frontend/images/services/services-details-img-5.jpg')}}" alt="">
                        <div class="services-details__icon">
                            <span class="icon-insurance"></span>
                        </div>
                    </div>
                    <h3 class="services-details__title-1">@lang('services.legal_and_administrative_support')</h3>
                    <p class="services-details__text-1">@lang('services.so')</p>
                    <div class="services-details__text-box">
                        <p class="services-details__text-box-text">@lang('services.sor')</p>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="services-details__benefit-content">
                                    ...
                                    <p class="services-details__benefit-text">@lang('services.sow')</p>
                                    <ul class="services-details__benefit-points list-unstyled">
                                        <li>
                                            ...
                                            <div class="text">
                                                <p>@lang('services.legal_expertise')</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                <p>@lang('services.risk_management')</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                <p>@lang('services.protection_of_legal_rights')</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                <p>@lang('services.cost_effective_solutions')</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
