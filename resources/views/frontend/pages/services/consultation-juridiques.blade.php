        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    <h2>@lang('services.legal_consultations')</h2>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="services-details__right">
                    <div class="services-details__img">
                        <img src="{{url('frontend/images/services/services-details-img-2.jpg')}}" alt="">
                        <div class="services-details__icon">
                            <span class="icon-insurance"></span>
                        </div>
                    </div>
                    <h3 class="services-details__title-1">@lang('services.legal_consultations')</h3>
                    <p class="services-details__text-1">@lang('services.da')</p>
                    <div class="services-details__text-box">
                        <p class="services-details__text-box-text">@lang('services.dar')</p>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="services-details__benefit-content">
                                    ...
                                    <p class="services-details__benefit-text">@lang('services.daw')</p>
                                    <ul class="services-details__benefit-points list-unstyled">
                                        <li>
                                            ...
                                            <div class="text">
                                                <p>@lang('services.avoiding_legal_pitfalls')</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                <p>@lang('services.access_to_resources')</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                <p>@lang('services.expert_advice')</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                <p>@lang('services.cost_savings')</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
