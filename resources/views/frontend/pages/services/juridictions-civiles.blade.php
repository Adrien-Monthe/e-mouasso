...
@section('content')
       ...
       <section class="page-header">
        <div class="page-header__bg" style="background-image: url('/frontend/images/backgrounds/services-2-2.jpg');">
        </div>
        ...
        <div class="container">
            <div class="page-header__inner">
                <h2>@lang('services.representation_and_assistance_in_civil_courts')</h2>
                <div class="thm-breadcrumb__inner">
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li><span>/</span></li>
                        <li>@lang('services.representation_and_assistance_in_civil_courts')</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="services-details__right">
                        <div class="services-details__img">
                            <img src="{{url('frontend/images/services/services-details-img-4.jpg')}}" alt="">
                            <div class="services-details__icon">
                                <span class="icon-insurance"></span>
                            </div>
                        </div>
                        <h3 class="services-details__title-1">@lang('services.representation_and_assistance_in_civil_courts')</h3>
                        <p class="services-details__text-1">@lang('services.fo')</p>
                        <div class="services-details__text-box">
                            <p class="services-details__text-box-text">@lang('services.for')</p>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="services-details__benefit-content">
                                        ...
                                        <p class="services-details__benefit-text">@lang('services.fow')</p>
                                        <ul class="services-details__benefit-points list-unstyled">
                                            ...
                                            <li>
                                                ...
                                                <div class="text">
                                                    <p>@lang('services.dispute_resolution')</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="icon">
